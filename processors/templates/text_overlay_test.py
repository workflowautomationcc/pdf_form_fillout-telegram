...
OUTPUT_PATH = os.path.join(BASE_DIR, "data/output/previews/text_test.png")
FONT_PATH = os.path.join(BASE_DIR, "data/fonts/arial.ttf")

TEST_VALUE = "4,200.00"

# 🔧 empirical vertical adjustment (negative = move up)
Y_OFFSET_RATIO = -0.15  # tweak later if needed
