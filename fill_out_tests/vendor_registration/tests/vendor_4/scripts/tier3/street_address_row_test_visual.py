"""
Visualize the scratch "2. Street Address" row test.

Draws only the matched word_positions boxes and labels them with OCR text.

Output:
  3_output/tier3/street_address_row_test_visual.png
"""
...
def run(page="page_1"):
    with open(TIER3_DIR / "street_address_row_test.json") as f:
        data = json.load(f)
    ...
    out_path = OUT_DIR / "street_address_row_test_visual.png"
    img.save(out_path)
